          ...
          <div className="grid items-center gap-16 lg:grid-cols-12">
            ...
            >
              ...
              <div className="flex flex-col gap-5 sm:flex-row">
                <Link
                  href="/carta"
                  className="relative overflow-hidden group rounded-full bg-[#1d4448] px-12 py-5 text-sm font-bold text-white transition-all duration-300 hover:shadow-[0_10px_30px_rgba(29,68,72,0.3)]"
                >
                ...
                <Link
                  href="/contacto"
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-[#1d4448]/20 px-12 py-5 text-sm font-bold text-[#1d4448] transition-all hover:border-[#1d4448]"
                >
                  Contacto
                </Link>
              </div>
                ...
                >
                  <svg viewBox="0 0 100 100" className="h-full w-full overflow-visible">
                    ...
                    <text
                      fontSize="8"
                      fontWeight="900"
                      className="fill-[#1d4448] uppercase tracking-[0.1em]"
                    >
